...
class Movie(models.Model):
    ...
    actor = models.CharField(max_length=280, verbose_name="主演", blank=True, null=True)
    tags = models.ManyToManyField(Tag, verbose_name="电影类型")
    image = models.ImageField(upload_to="movie/%Y/%m", default="movie/default.png",
                              max_length=100, verbose_name="电影图", null=True, blank=True)
    languages = models.ManyToManyField(Language, verbose_name="语言")
    region_id = models.ForeignKey(Region, on_delete=models.CASCADE, verbose_name="产地")
    release_date = models.DateField(verbose_name="上映时间", null=True, blank=True)
    intro = models.TextField(max_length=800, verbose_name="电影介绍", default='')
    ...
    download_url = models.TextField(max_length=500, verbose_name="下载地址", null=True, blank=True)
